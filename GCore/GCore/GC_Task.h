...
namespace gcore
{
	...
	*/
	...
	public:
		...
		*/
		Task( TaskPriority priority = TaskPriority() ,const std::string& name = std::string() );
		...
		*/
		...
		/** Priority : ascending order of execution for each cycle.
			@see 
		*/
		const TaskPriority& priority() const { return m_priority; }

		/// Current state of the Task.
		const TaskState& state() const { return m_state; }
