...
namespace gcore
{
	...
	*/
	...
	public:
		...
		*/
		TimedTask( bool terminateOnceDone = false , TaskPriority priority = TaskPriority() ,const std::string& name = std::string() );
...
#pragma warning( disable : 4250 ) // we want to use ProxyTask definitions, yes..
	...
	public:
		TimedProxyTask( const TaskFunction& executeFunction, bool terminateOnceDone = false 
			...
			, TaskPriority priority = 0, const std::string& name = "" ) 
