...
namespace gcore
{
	...
	*/
	...
	public:
		...
		**/
		virtual void catchLogMessage(Log& log ,const std::string& message)=0;
	...
	typedef std::tr1::function< void ( Log&, const std::string& ) > LogListenerFunction;
	...
	public:
		...
		inline void catchLogMessage(Log& log ,const std::string& message)
		{
